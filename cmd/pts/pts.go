...
func main() {
	...
	js.Global().Call("postMessage", map[string]any{"$$": []any{string(pont.ChaCha20_Poly1305_SHA256), string(pont.ChaCha20_Poly1305_SHA512), string(pont.AES_256_GCM_SHA256), string(pont.AES_256_GCM_SHA512)}})
